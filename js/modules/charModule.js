// ============================================================
// MODULE TAB 3: CHARACTER CASTING (FULL VERSION)
// ============================================================
...
window.renderCharCards = () => {
    ...
    container.innerHTML = chars.map((char, index) => {
        ...
        const modelOptions = [
            ...
            {val: 'turbo', label: 'Turbo (Super Fast)'},
...
window.generateChar = async (index) => {
    ...
    // Kita paksa prompt ini biar hasilnya konsisten buat referensi
    ...
    // URL STABIL (pollinations.ai/p/)
    const url = `https://pollinations.ai/p/${encodedPrompt}?width=${width}&height=${height}&seed=${seed}&model=${selectedModel}&nologo=true`;
